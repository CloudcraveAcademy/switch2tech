...
if ($result_course && $row_course = $result_course->fetch_assoc()) {
    ...
    echo "<p>No free courses found.</p>";
}
?>
                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col-lg-6 col-md-8">
                              <div class="tp-live-content">
                                 ...
                                 <h4 class="tp-live-title"><a href="course-details-2.html"><?php echo htmlspecialchars($row_course['course_name']); ?></a></h4>
                                 <div class="tp-live-total">
                                    ...
                                    <div class="tp-live-join">
                                       <a class="tp-btn-border" href="contact.html">
