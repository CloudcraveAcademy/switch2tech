...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO courses (course_name, description, prerequisites, level, duration, price, discount_percentage, mode, registration_deadline, category_id, status, instructor_id, intro_video_url, course_image_url)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
