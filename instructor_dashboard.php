         ...
         require_once 'instructor_menu.php';
                  ...
                  <div class="col-lg-9">
                     ...
                     <div class="tpd-content-layout">
                        ...
                        <!-- fact-area-start -->
                        <?php
         require_once 'instructor_numbers.php';
                          ?> 
                        <!-- fact-area-end -->
   
                        <!-- progress-area-start -->
                        <?php
         //require_once 'course_in_progress.php';
                          ?>  
                        <!-- progress-area-end -->
                   <!-- in courses-area-end -->
                        <?php
                                    ...
                                    <ul>
                                       <li class="active">
                                          <div class="tp-dashboard-course-item">
                                             ...
                                             <div class="tp-dashboard-course-name">
                                                <h5 class="tp-dashboard-course-name-title">Period </h5>
                                             </div>
                                       ...
                                       <li>
                                          <div class="tp-dashboard-course-item">
                                             <div class="tp-dashboard-course-name">
                                                <h5 class="tp-dashboard-course-name-title">Software Development with PHP / MySQL</h5>
                                             </div>
                                             <div class="tp-dashboard-course-name">
                                                <h5 class="tp-dashboard-course-name-title">Jan - March 2024</h5>
                                             </div>
                                             <div class="tp-dashboard-course-enroll">
                                                <span>25</span>
                                             </div>
                                       ...
                                       <li>
                                          <div class="tp-dashboard-course-item">
                                             <div class="tp-dashboard-course-name">
                                                <h5 class="tp-dashboard-course-name-title">Advanced Excel and Data Analytics</h5>
                                             </div>
                                             <div class="tp-dashboard-course-name">
                                                <h5 class="tp-dashboard-course-name-title">Jan - March 2024</h5>
                                             </div>
