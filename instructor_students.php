                           ...
                           <div class="row">
                              <div class="col-8">
                                 <div class="tp-dashboard-section">
                                    <h2 class="tp-dashboard-title">My Students</h2>
                                 </div>
                              </div>
                                    ...
                                    <ul>
                                       <li class="active">
                                          ...
                                          <div class="tp-dashboard-course-enroll">
                                                <h5 class="tp-dashboard-course-name-title">Student Name</h5>
                                             </div>
                                             <div class="tp-dashboard-course-enroll">
                                                <span>email  </span>
                                             </div>
...
// Fetch instructor_id from session or GET parameter
...
if (!$instructor_id) {
    ...
    exit; // Stop execution if the instructor ID is not available.
}

// Prepare SQL to fetch students related to the instructor
$query = "SELECT s.student_id, s.name AS name, s.email, s.student_status, s.created_at, c.course_name
          FROM students s
...
if ($stmt = mysqli_prepare($conn, $query)) {
    // Bind the instructor_id as a parameter
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="tp-dashboard-course-enroll">
                ...
                <div class="tp-dashboard-course-enroll">
                    <span><?php echo htmlspecialchars($row['email']); ?></span> <!-- Display student name -->
                </div>
               
                <div class="tp-dashboard-course-rating">
                    <span><?php echo date('F j, Y', strtotime($row['created_at'])); ?></span> <!-- Display enrollment date -->
                </div>
                <div class="tp-dashboard-course-rating">
        ...
        echo "<p>No students found for this instructor.</p>";
    }
