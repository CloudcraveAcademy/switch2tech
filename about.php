               ...
               <div class="row align-items-center">
                  <div class="col-lg-12">
                     <div class="tp-about-banner mb-80">
                        <span>About Us</span>
                        <h3 class="tp-about-banner-title">We offer top-quality  <br>
                        virtual courses & career guidance.</h3>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row g-0">
                  ...
                  <div class="col-xl-6 col-lg-12">
                     <div class="tp-about-banner-content p-relative">
                        ...
                        <p>We offer top-quality online courses designed<br> to provide you with the skills and knowledge<br> needed for success in the tech industry.</p>
               ...
               <div class="row align-items-end">
                  <div class="col-lg-6">
                     <div class="tp-about-tutor-heading mb-130">
                        ...
                        <h3 class="tp-about-tutor-title">We combine expert instructors, <br>
                        real-world projects,</h3>
                        <p>
                             and flexible learning options to ensure an engaging and effective learning experience  and
                             industry-relevant content, allowing you to apply what you learn immediately and confidently transition into tech roles.
                              </p>
                              <p>
                                At CloudCrave Academy, we are dedicated to empowering individuals to thrive in the rapidly evolving tech landscape. Our comprehensive virtual learning platform offers a wide range of courses designed to equip students with the essential skills needed for a successful career in technology. From software development and data analytics to cybersecurity and cloud computing, our curriculum is tailored to meet the demands of today’s job market—all at an affordable price.<p>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="tp-about-tutor-right d-flex justify-content-lg-end mb-130">
                        <div class="tp-about-tutor-content">
                                ...
                                <p>We believe that high-quality education should be accessible to everyone, which is why we operate in Nigeria, the UK, the USA, and Canada. Our competitive pricing and flexible payment options ensure that you can pursue your tech career without financial strain. Our experienced instructors bring a wealth of industry knowledge and expertise, providing personalized guidance and support throughout your learning journey. With a focus on practical, hands-on experience, our courses ensure that you gain real-world skills that can be immediately applied in the workplace.<p>

                                <p>Join our vibrant online community of learners, where you can connect with peers, share experiences, and celebrate successes. Subscribe to our monthly newsletter for the latest updates, tips, and resources to help you excel in your tech career. At CloudCrave Academy, we are committed to your growth and success, helping you turn your passion for technology into a fulfilling and affordable career.<p>
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                     <div class="tp-tutor-item about text-center mb-30">
                        ...
                        <div class="tp-tutor-content">
                           <h4 class="tp-tutor-title"><a href="#">Professional Instructors</a></h4>
                           <p>Get one-on-one help from our experienced professionals.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                     <div class="tp-tutor-item about text-center mb-30">
                        ...
                        <div class="tp-tutor-content">
                           <h4 class="tp-tutor-title"><a href="#">Career Guidance</a></h4>
                           <p>Get career guidance from industry experts.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                     <div class="tp-tutor-item about text-center mb-30">
                        ...
                        <div class="tp-tutor-content">
                           <h4 class="tp-tutor-title"><a href="#">Class Recording</a></h4>
                           <p>Every class is recorded and shared at no additional charge.</p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-instructor-counter-item text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="10"  class="purecounter">300</span>+
                        </h3>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-instructor-counter-item text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="240"  class="purecounter">34</span>
                        </h3>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-instructor-counter-item item-end text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="110"  class="purecounter">4</span>
                        </h3>
                        <p>Countries</p>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-8">
                     <div class="tp-our-mission-wrapper wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-our-mission-heading">
                           ...
                           <p>Our mission is to empower individuals with the skills, knowledge, and support they need to successfully transition into rewarding tech careers. We are committed to delivering high-quality, accessible education that drives innovation and opens doors to new opportunities in the ever-evolving tech industry.</p>
                        </div>
                     ...
                     <div class="tp-our-mission-item about d-flex align-items-center justify-content-center justify-content-md-between mb-20">
                           <div class="tp-our-mission-item-content">
                              <h4 class="tp-our-mission-item-title">Excellence</h4>
                              <p>We deliver high-quality education that equips students with the skills to succeed in the tech industry.</p>
                        ...
                        <div class="tp-our-mission-item about d-flex align-items-center justify-content-center justify-content-md-between mb-20">
                           <div class="tp-our-mission-item-content">
                              <h4 class="tp-our-mission-item-title">Accessibility</h4>
                              <p>We believe in making tech education affordable and available to everyone, regardless of background.</p>
                              <div class="tp-our-mission-item-btn">
                                 <a class="tp-btn-3" href="#">Learn More <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                                       <path d="M1.5 6H11.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="tp-our-mission-item about d-flex align-items-center justify-content-center justify-content-md-between">
                           <div class="tp-our-mission-item-content">
                              <h4 class="tp-our-mission-item-title">Support</h4>
                              <p> We provide continuous mentorship and career guidance to help our students achieve their professional goals.</p>
                              <div class="tp-our-mission-item-btn">
                                 <a class="tp-btn-3" href="#">Learn More <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                                       <path d="M1.5 6H11.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
$query_ins = "SELECT * FROM instructors";
