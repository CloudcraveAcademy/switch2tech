...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   $registration_deadline = $_POST['timezone'] ?? null;
   ...
   $sql = "INSERT INTO courses (course_name, description, prerequisites, level, duration, price, discount_percentage, mode, registration_deadline, session_duration, timezone,   training_days, daily_start_time, course_start_date, category_id, status, instructor_id, intro_video_url, course_image_url)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
   ...
   if ($stmt->execute()) {
      ...
      echo '<script>alert("Course info uploaded successfully!");</script>';
   } else {
...
<div class="accordion-item">
   ...
   <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
      <div class="accordion-body">
         <form id="create-course-form" action="create_course1.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="tpd-new-course-box-1">
               ...
               <div class="tpd-input-box d-flex">
                  ...
                  <div class="tpd-input">
                     <label for="session-duration">Session Duration (Munites):</label>
                     <input type="number" id="session-duration" name="session_duration" placeholder="Enter duration per session" required>
               ...
               <div class="tpd-input-box" style="width: 100%;">
                  <!-- Training Days Label -->
                  <label for="training_days"><b>Training Days:</b></label>

                  <!-- Checkbox Groups - Two Rows -->
                  <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                     <!-- First Row: Sunday to Wednesday -->
                     <div style="flex: 1; display: flex; gap: 15px;">
                        <div>
                           <input type="checkbox" id="sunday" name="training_days[]" value="Sunday">
                           <label for="sunday">Sunday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="monday" name="training_days[]" value="Monday">
                           <label for="monday">Monday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="tuesday" name="training_days[]" value="Tuesday">
                           <label for="tuesday">Tuesday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="wednesday" name="training_days[]" value="Wednesday">
                           <label for="wednesday">Wednesday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="thursday" name="training_days[]" value="Thursday">
                           <label for="thursday">Thursday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="friday" name="training_days[]" value="Friday">
                           <label for="friday">Friday</label>
                        </div>
                        <div>
                           <input type="checkbox" id="saturday" name="training_days[]" value="Saturday">
                           <label for="saturday">Saturday</label>
                        </div>
                     </div>

                     <!-- Daily Start Time -->
                     <div class="tpd-input" style="margin-top: 15px; width: 50%;">
                        <label for="daily_start_time">Daily Start Time:</label>
                        <input type="time" id="daily_start_time" name="daily_start_time" required style="width: 100%;">
                     </div>
                  </div>
      ...
      <!-- Course Categories -->
      <div class="tpd-new-course-box-6">
         <div class="tpd-new-course-categories">
            <div class="tpd-new-course-select2">
               <div class="tpd-input">
                  <label for="course-category">Choose a Category</label><br>
                  <select id="course-category" name="course_category" class="form-select" required>
                     <?php
                     // Include database connection
            ...
            <div class="tpd-input">
               ...
               <input type="datetime-local" id="course-start-date" name="course_start_date" class="form-control" required>
               <!-- <input type="datetime-local" id="course-start-date" name="course_start_date" class="form-control" required> -->
